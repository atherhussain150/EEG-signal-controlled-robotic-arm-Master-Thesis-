...
for i in range (100):
	myKeys = loadmat("Nothing\\Rescale_EEG_Data_Nothing" + str(i+1) + ".mat")
	print(myKeys)
	eegData = myKeys['EEG_Data_rescale']
	print(eegData.shape)

	for k in range (1536, 2536, 2):
		epochs = eegData[k]
...
for i in range (100):
	myKeys = loadmat("Pull\\Rescale_EEG_Data_Pull" + str(i+1) + ".mat")
	print(myKeys)
	eegData = myKeys['EEG_Data_rescale']
	print(eegData.shape)
...
for i in range (100):
	myKeys = loadmat("Push\\Rescale_EEG_Data_Push" + str(i+1) + ".mat")
	print(myKeys)
	eegData = myKeys['EEG_Data_rescale']
	print(eegData.shape)
...
print (total_input_data_with_labels.shape)

savetxt('window_1536_with_labels_23_04_05.csv', total_input_data_with_labels, delimiter=',')
